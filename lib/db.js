...
const service = {
  ...
  getUserCheckIn: (user) => {
    let promise = new Promise((resolve, reject) => {
      service.client.get(user + '_check_in_today', (data) => {
        resolve(data);
      });
    });
  ...
  getUserCheckInTime: (user) => {
    let promise = new Promise((resolve, reject) => {
      service.client.get(user + '_check_in_time', (data) => {
        resolve(data);
      });
    });
  ...
  getUserCheckOut: (user) => {
    let promise = new Promise((resolve, reject) => {
      service.client.get(user + '_check_out_today', (data) => {
        resolve(data);
      });
    });
  ...
  getUserCheckOutTime: (user) => {
    let promise = new Promise((resolve, reject) => {
      service.client.get(user + '_check_out_time', (data) => {
        resolve(data);
      });
    });
